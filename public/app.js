...
var VideoChat = {
  ...
  createAnswer: function (offer) {
    return function () {
      ...
      VideoChat.peerConnection.addEventListener("datachannel", (event) => {
        logIt("--- Got data channel");
        console.log(event);
        VideoChat.dataChannel = event.channel;
        VideoChat.dataChannel.addEventListener("open", () => {
          logIt("--- Guest data channel open!!!");
        });
        VideoChat.dataChannel.addEventListener("close", () => {
  ...
  onAnswer: function (answer) {
    ...
    VideoChat.dataChannel = VideoChat.peerConnection.createDataChannel("chat");
